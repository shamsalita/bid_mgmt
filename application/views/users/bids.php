                    ...
                    <tr class="<?php echo $tr_class; ?>">
                      ...
                      <?php } ?>
                        ...
                        <td>
                            ...
                            ?>
                            <?php
                            if($this->session->userdata('user')['role'] == 2 && $bid_data['status'] == 1){
                            ?>
                              <a class="btn btn-success" data-bidid="<?php echo $bid_data['id']; ?>" data-role="<?php echo $user_role; ?>" href="<?php echo base_url() . $user_role; ?>bids/edit_bid/<?php echo $bid_data['id']; ?>">Edit</a>
                            <?php
                            }
                            ...
                            <a class="btn btn-info change_status make_bid" data-bidid="<?php echo $bid_data['id']; ?>" data-role="<?php echo $user_role; ?>">Bid</a>
                            <?php
                              }
