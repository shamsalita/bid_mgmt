...
class Bids extends CI_Controller {
    ...
    */
    public function index()
    {
        ...
        $data['tech_arr'] = array("All Tech","PHP","React","Vue","React + Laravel","Laravel","CI","Angular","Node","MERN","MEAN","Laravel + Vue","Need to select","Fullstack","Angular + aravel","Angular + PHP","Wordpress","Front End","Shopify app","React + Node","PERN","React + PHP","QA + Testing","WebFlow","WebFlow + SEO");
