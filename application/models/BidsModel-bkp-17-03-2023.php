        ...
        if(!empty($selected_date_filter)) {
            if(!empty($selected_date_filter)){
                if($type == 1){
                    ...
                    $this->db->where('(b.lead_date LIKE "' . $selected_date_filter . '%" OR b.conversion_date LIKE "' . $selected_date_filter . '%" OR b.created LIKE "' . $selected_date_filter . '%")');
                    // $this->db->or_where('b.conversion_date LIKE "' . $selected_date_filter . '%"');
                }elseif($type == 3){
                    $this->db->where('(b.conversion_date LIKE "' . $selected_date_filter . '%" OR b.lead_date LIKE "' . $selected_date_filter . '%" OR b.created LIKE "' . $selected_date_filter . '%")');
                }
            }
        }
        if($type > 0){
